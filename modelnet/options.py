...
class Options():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--dataroot', default='../data/modelnet/modelnet40-normal_numpy/', help='path to images & laser point clouds')
        ...
        self.parser.add_argument('--checkpoints_dir', type=str, default='./checkpoints/MN40_2ly', help='models are saved here')
